...
<body class="bg-gray-200 p-4">
    <div class=lg:w-2/4 mx-auto py-6 px-8 bg-white rounded-xl">
    ...
    <div class="mb-6">
        <form class="flex flex-col space-y-4" method="POST" action="/">
            ...
            <textarea name="description" placeholder="Todo descripyion" clas="py-3 px-4 bg-gray-100 rounded-xl"></textarea>
